"""v4: Integrate car collision into game loop and prevent the enemies
from using the player car's colour
Jack Andrews
8/05/2023
"""
import pygame
...
def render_death():
    win.blit(transparent_screen, [0, 0])
    draw_text("You died!", "black", (WIDTH // 2, HEIGHT // 2))
    if ms_elapsed > 5000:
        # 5 second delay before exiting
        pygame.quit()
        exit()
