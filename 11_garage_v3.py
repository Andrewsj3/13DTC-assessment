"""Version 3: Add preview window to Garage menu
Jack Andrews
16/5/23"""
import pygame
WIDTH = 600
...
class Game:
    ...
    def render_garage(cls):
        width, height = Game.car.img.get_width(), Game.car.img.get_height()
        preview_window = pygame.transform.smoothscale(Game.car.img, [width*1.3, height*1.3])
        ...
        cls.win.blit(preview_window, preview_window.get_rect(center=[WIDTH//2, 250]))
