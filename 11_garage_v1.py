"""Version 1: Allow the user to change the colour of their car
Jack Andrews
16/5/23"""
import pygame
WIDTH = 600
...
class Game:
    ...
    def render_garage(cls):
        ...
        cls.draw_text("Colours", "black", [30, HEIGHT // 2], align="left")
        cls.draw_text(
            "Stripes", "black", [
